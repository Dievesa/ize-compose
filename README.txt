...
글자를 치던 중 글자가 완성되지 않은 상태에서 화살표로 커서 이동 시 자음 등이 따라오는 현상이 있습니다. 반드시 스페이스바를 누른 후 이동해 주세요. 자모음 분리하여 보이게 하다보니 나온 현상인데, 글자가 다 만들어지고 나서 보이게 할지 중간에도 보이게 할지 중 선택하다보니 나온 현상입니다.
<원인을 찾았고 현재 수정 중입니다. 늦어도 5월 12일 까지 수정분을 업로드할 예정입니다. > 
